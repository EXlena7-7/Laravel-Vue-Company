<template>
    <div :class="$page.props.showingMobileMenu ? 'block' : 'hidden'" @click="$page.props.showingMobileMenu = false"
         class="fixed inset-0 z-20 bg-gray-900 opacity-50 transition-opacity lg:hidden"></div>
    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <div class="flex justify-center items-center mt-8">
            <i class="fa-brands fa-laravel text-3xl text-white"></i>
            <i class="fa-brands fa-vuejs text-3xl text-white"></i>
            <span class="mx-2 text-2xl font-semibold text-white">Company</span>
        </div>
